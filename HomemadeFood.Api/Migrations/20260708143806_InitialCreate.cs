    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProducerProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProducerProfiles_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Foods_ProducerProfiles_ProducerProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryAddress = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DeliveryLatitude = table.Column<double>(type: "double", nullable: false),
                    DeliveryLongitude = table.Column<double>(type: "double", nullable: false),
                    TotalPrice = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    Status = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SuitabilityScore = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Foods_ProducerProfileId",
                table: "Foods",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ProducerProfileId",
                table: "Orders",
                column: "ProducerProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ProducerProfiles_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ProducerProfileId",
                table: "Reviews",
                column: "ProducerProfileId");
        }
