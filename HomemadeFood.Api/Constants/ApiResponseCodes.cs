namespace HomemadeFood.Api.Constants
{
    public static class ApiResponseCodes
    {
        ...
        public const string OrderCancellationFailed =
            "ORDER_CANCELLATION_FAILED";

        public const string ReviewCreationFailed =
    ...
    "CART_ITEM_ADDITION_FAILED";
        ...
        public const string CartItemRemovalFailed =
    ...
    "FOOD_NOT_FOUND";
        ...
        public const string FoodUpdateFailed =
            "FOOD_UPDATE_FAILED";
    ...
    "ORDER_ACCEPTANCE_FAILED";
        ...
        public const string OrderPreparationFailed =
            "ORDER_PREPARATION_FAILED";

        public const string OrderReadyFailed =
            "ORDER_READY_FAILED";

        public const string OrderDeliveryStartFailed =
            "ORDER_DELIVERY_START_FAILED";
